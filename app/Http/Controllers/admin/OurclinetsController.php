        ...
        if ($validator->passes()) {
            ...
            if (isset($_FILES['image']['size'])) {
                if ($_FILES['image']['size'] > 0) {
                    ...
                    $this->upload_images(ORIGNAL_IMAGE_PATH_CLIENTS,LARGE_IMAGE_PATH_CLIENTS,MEDIUM_IMAGE_PATH_CLIENTS,SMALL_IMAGE_PATH_CLIENTS,$request->file('image'), $updateId, 'image','id', 'ourclinets');
