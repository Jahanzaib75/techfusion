						...
						<div class="row">
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
								<div class="card overflow-hidden dash1-card border-0">
									<div class="card-body">
										...
										<h2 class="mb-1 number-font">{{ $clients ??'' }}</h2>
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
								<div class="card overflow-hidden dash1-card border-0">
									<div class="card-body">
										<p class=" mb-1 ">Join Us Emails:</p>
										<h2 class="mb-1 number-font">{{$qoute ??''}}</h2>
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
								<div class="card overflow-hidden dash1-card border-0">
									<div class="card-body">
										<p class=" mb-1">Subscription Email:</p>
										<h2 class="mb-1 number-font">{{$sub}}</h2>
