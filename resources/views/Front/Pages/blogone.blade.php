...
<section class="blog-details ptb-120">
        ...
        <div class="row justify-content-between">
            <div class="col-lg-8 pe-5">
                <div class="blog-details-wrap">
                    ...
                    <img src="{{asset('front')}}/img/tab-feature-img-4.png" class="img-fluid mt-4 rounded-custom" alt="apply">
                    ...
                    <img src="{{asset('front')}}/img/tab-feature-img-2.png" class="img-fluid mt-5 rounded-custom" alt="apply">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="author-wrap text-center bg-light p-5 sticky-sidebar rounded-custom mt-5 mt-lg-0">
                    <img src="{{asset('front')}}/img/team/team-2.jpg" alt="author" width="120" class="img-fluid shadow-sm rounded-circle">
    ...
    <div class="container">
        <!--cat subscribe start-->
        <div class="bg-dark ptb-60 px-5 mt-100 position-relative overflow-hidden rounded-custom" style="background: url('img/page-header-bg.svg')no-repeat center bottom">
